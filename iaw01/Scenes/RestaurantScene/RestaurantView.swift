...
final class RestaurantView: UIView {
    ...
    func setupLayoutAndConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            headerImageView.leadingAnchor.constraint(equalTo: scrollView.leadingAnchor, constant: 21),
            headerImageView.trailingAnchor.constraint(equalTo: scrollView.trailingAnchor, constant: -21),
